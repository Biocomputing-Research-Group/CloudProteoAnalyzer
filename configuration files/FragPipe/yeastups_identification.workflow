...
database.db-path=/home/UNT/jl0734/Desktop/DIA/web/database/decoy_yeast_ups1.fasta

crystalc.run-crystalc=false
database.decoy-tag=DECOY_
...
msfragger.fragment_mass_tolerance=0.5
...
msfragger.precursor_mass_lower=-0.05
msfragger.precursor_mass_mode=selected
msfragger.precursor_mass_units=0
msfragger.precursor_mass_upper=0.05
msfragger.precursor_true_tolerance=0.05
...
msfragger.table.fix-mods=0.0,C-Term Peptide,false,-1; 0.0,N-Term Peptide,false,-1; 0.0,C-Term Protein,false,-1; 0.0,N-Term Protein,false,-1; 0.0,G (glycine),false,-1; 0.0,A (alanine),false,-1; 0.0,S (serine),false,-1; 0.0,P (proline),false,-1; 0.0,V (valine),false,-1; 0.0,T (threonine),false,-1; 57.02146,C (cysteine),false,-1; 0.0,L (leucine),false,-1; 0.0,I (isoleucine),false,-1; 0.0,N (asparagine),false,-1; 0.0,D (aspartic acid),false,-1; 0.0,Q (glutamine),false,-1; 0.0,K (lysine),false,-1; 0.0,E (glutamic acid),false,-1; 0.0,M (methionine),false,-1; 0.0,H (histidine),false,-1; 0.0,F (phenylalanine),false,-1; 0.0,R (arginine),false,-1; 0.0,Y (tyrosine),false,-1; 0.0,W (tryptophan),false,-1; 0.0,B ,false,-1; 0.0,J,false,-1; 0.0,O,false,-1; 0.0,U,false,-1; 0.0,X,false,-1; 0.0,Z,false,-1
...
phi-report.filter=--sequential --picked --prot 0.01 --pep 0.01 --psm 0.01
