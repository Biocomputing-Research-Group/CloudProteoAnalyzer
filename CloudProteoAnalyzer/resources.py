google_auth_file="" # the path of google client ID credentials json file
web_url="" # your url
server_data_path="" # the path of all ms data and fasta on supercomputer
raxport_path="" # the path of Raxport on server
script_path="" # the path of Sipros Ensemble python script

user_data_path = ""  # the path of all ms data and fasta on server part
host_inf = {"host":"", # supercomputer address
                "username":"", # supercomputer user name
                "passwords":""} #supercomputer user password

'''
Gemail used for sending results back
'''
